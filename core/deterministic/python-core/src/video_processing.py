...
class VideoProcessing:
    def __init__(self, video_path, config_parameters: ConfigVideoParameters):
    ...
    def process_video(self):
        ...
        # Saving file
        path = self.config_parameters.base_path + self.config_parameters.path_out
        self.video.write(frames_out= frames, path= path, fps= self.config_parameters.fps, gray= self.config_parameters.gray)
        return path
