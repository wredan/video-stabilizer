...
class VideoProcessing:
    ...
    def process_video(self):
        ...
        shifted_frames = self.smoothing.shift_frames(self.video.frames_inp, global_correct_motion_vectors, self.config_parameters.intensity)
        FramesPrintDebug().write_video(
            ...
            second_quadrant= shifted_frames)
